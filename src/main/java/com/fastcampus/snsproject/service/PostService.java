...
public class PostService {
    ...
    public void like(Integer postId, String userName) {
        ...
        alarmEntityRepository.save(AlarmEntity.of(postEntity.getUser(), AlarmType.NEW_LIKE_ON_POST, new AlarmAgrs(userEntity.getId(), postEntity.getId())));
    }
...
//        List<LikeEntity> likeEntites = likeEntityRepository.findAllByPost(postEntity);
    ...
    public void comment(Integer postId, String userName, String comment) {
        ...
        alarmEntityRepository.save(AlarmEntity.of(postEntity.getUser(), AlarmType.NEW_COMMENT_ON_POST, new AlarmAgrs(userEntity.getId(), postEntity.getId())));
    }
